...
flow = flow_from_clientsecrets('/Users/kyle/Downloads/gdata_creds.json', scope='https://spreadsheets.google.com/feeds', redirect_uri='http://localhost')
...
storage = Storage('/Users/kyle/.gdata.creds')
